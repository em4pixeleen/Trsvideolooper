...
class VideoLooper(object):
    ...
    def _load_player(self):
        ...
        return importlib.import_module('.' + module, 'Trs_Video_Looper') \
    ...
    def _animate_countdown(self, playlist, seconds=10):
        ...
        message = '{0} video{1} detectado{1}.'.format(playlist.length(), 
        ...
        label1 = self._render_text(message + ' Reproduciendo en:')
        ...
        while self._running:
            ...
            if not self._player.is_playing():
                ...
                if movie is not None:
                    ...
                    self._print('Reproduciendo video: {0}'.format(movie))
...
if __name__ == '__main__':
    print('Iniciando Trison Video Looper.')
